    ...
    <section className="pt-8 pb-20 md:p-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip">
      <div className="container">
        ...
        <div className="mt-20 md:-mt-0 md:h-[648px] md:flex-1 relative">
          <Image src={cogMain} alt="cog" className="md:absolute  md:width-auto md:max-w-none md:-left-6 lg:left-0" />
          <Image src={cogImage} alt="Img" width={220} height={220} className="hidden md:block -top-8 -left-32 md:absolute"/>
          <Image src={noodleImage} alt="Img" width={220} className="hidden lg:block absolute top-[524px] left-[448px] rotate-[30deg]"/>
        </div>
        </div>
      </div>
    </section>
