...
export const Footer = () => {
  return (
    <footer className="bg-green-950 text-[#BCBCBC] text-sm py-10 text-center">
      <div className="container">
        ...
        <Image src={Logo} alt="African Witch Tech Logo" height={60} className="relative" />
        </div>
...
<p className="mt-6">&copy; 2025 African Witch Tech Limited. All rights reserved.</p>
      </div>
    </footer>
  )
};
